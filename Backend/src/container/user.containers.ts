...
export const makeUserController = () => {
  ...
  const subscribeUseCase = new SubscribeUseCase(userRepository, subscriptionRepository);

  return new UserController(upgradeUseCase, reapplyUseCase, editProfileUseCase, subscribeUseCase);
};
