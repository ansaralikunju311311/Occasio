  ...
  implements IUserRepository
{
  ...
  async findByEmail(email: string): Promise<User | null> {
    ...
    return doc ? userMapper.toDomain(doc as unknown as Record<string, unknown>) : null;
  }
  ...
  async updateUser(
    ...
    if (persistenceData.activeSubscription) {
      persistenceData.activeSubscription = persistenceData.activeSubscription as unknown as mongoose.Schema.Types.ObjectId;
    }
