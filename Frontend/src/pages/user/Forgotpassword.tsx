        ...
        <div className="bg-slate-900/60 backdrop-blur-xl p-8 md:p-12 rounded-4xl shadow-2xl shadow-indigo-500/10 border border-slate-800 w-full max-w-md transition-all">
          <div className="flex justify-between items-center mb-8">
            <button
              ...
              className="flex items-center text-sm font-medium text-slate-400 hover:text-indigo-400 transition-colors group"
            >
              <svg
          ...
          <div className="text-left mb-10">
            ...
            <p className="mt-2 text-sm text-slate-400">
              Enter your registered email address and we'll send you a One-Time Password to reset
              your credentials.
            </p>
          </div>
