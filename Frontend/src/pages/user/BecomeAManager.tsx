...
const RocketIcon = () => (
  <svg className="w-6 h-6 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path
      ...
      strokeWidth={2}
      d="M15.59 14.37a6 6 0 01-5.84 0M4.74 11.24a3 3 0 013.12-2.9 3.1 3.1 0 011.85.61 3.1 3.1 0 011.85-.61 3 3 0 013.12 2.9M12 3c-1.1 0-2 .9-2 2v2h4V5c0-1.1-.9-2-2-2z"
    />
...
const BecomeAManager: React.FC = () => {
  ...
  const perks = [
    ...
    },
    {
      ...
      description:
        'Keep a larger share of your ticket sales and unlock premium monetization features.',
    },
    {
      icon: <UsersIcon />,
  ...
  const handleReapply = async () => {
    try {
      ...
      const errorMessage =
        error.response?.data?.message || 'Failed to re-apply. Please try again later.';
        ...
        {user?.role === 'EVENT_MANAGER' ? (
          <div className="max-w-2xl mx-auto text-center animate-in fade-in zoom-in-95 duration-500">
            ...
            <p className="text-slate-400 text-lg mb-10 max-w-md mx-auto">
              You are already an Event Manager. You can access your specialized tools and manage
              your events from the dashboard.
            </p>
            <button
          ...
          <div className="max-w-2xl mx-auto text-center animate-in fade-in zoom-in-95 duration-500">
            ...
            <p className="text-slate-400 text-lg mb-10 max-w-md mx-auto">
              Unfortunately, your application to become an event manager has been rejected at this
              time. Please contact support for more information or try again later.
            </p>
          ...
          <div className="max-w-2xl mx-auto text-center animate-in fade-in zoom-in-95 duration-500">
            ...
            <p className="text-slate-400 text-lg mb-10 max-w-md mx-auto">
              Your application to become an event manager is currently pending admin approval. You
              will receive an update once it's reviewed.
            </p>
            <button
              onClick={() => navigate('/')}
              className="px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-2xl transition-all"
          ...
          <>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-5 duration-700">
                  ...
                  <p className="text-xl text-slate-400 max-w-lg leading-relaxed">
                    Stop attending. Start leading. Our manager tools give you everything you need to
                    build a thriving event ecosystem.
                  </p>
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      {...register('aboutEvents', {
                        required: 'Description is required',
                        minLength: {
                          value: 20,
                          message: 'Please provide a bit more detail (min 20 chars)',
                        },
                      })}
                    ...
                    />
                    {errors.aboutEvents && (
                      <p className="text-red-500 text-xs mt-1 ml-1">{errors.aboutEvents.message}</p>
                    )}
                  </div>

                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-300 ml-1">
                      Past Event / Social Proof Links
                    </label>
                    <input
                      type="text"
                      placeholder="Links to past events, Instagram, LinkedIn, etc."
                      {...register('socialLinks', {
                        required: 'Social proof is required for verification',
                      })}
                    ...
                    />
                    {errors.socialLinks && (
                      <p className="text-red-500 text-xs mt-1 ml-1">{errors.socialLinks.message}</p>
                    )}
                  </div>

                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-300 ml-1">
                      Identity Verification / Document Reference
                    </label>
                    <input
                      type="text"
                      placeholder="e.g. ID Number, GST Number, or Document Link"
                      {...register('documentReference', {
                        required: 'Identity verification reference is required',
                      })}
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-300 ml-1">
                      Upload Certificate / Proof of Work (Image)
                    </label>
                    <div
                      className={`relative group border-2 border-dashed ${errors.certificate ? 'border-red-500' : 'border-slate-800'} hover:border-indigo-500/50 rounded-2xl p-8 transition-all bg-slate-800/20 text-center`}
                    >
                      <input
                        type="file"
                        accept="image/*"
                      ...
                      {!preview ? (
                        <div className="space-y-3">
                          ...
                          <div className="text-sm text-slate-400">
                            <span className="text-indigo-400 font-bold">Click to upload</span> or
                            drag and drop
                          </div>
                    ...
                    {errors.certificate && (
                      <p className="text-red-500 text-xs mt-1 ml-1">
                        {errors.certificate.message?.toString()}
                      </p>
                    )}
                  </div>
            ...
            {view === 'success' && (
              <div className="max-w-2xl mx-auto text-center animate-in fade-in zoom-in-95 duration-500">
                ...
                <p className="text-slate-400 text-lg mb-10 max-w-md mx-auto">
                  Thank you for applying. Our admin team will review your proof of work and identity
                  details. You'll hear from us within 24-48 hours.
                </p>
                <button
                  onClick={() => navigate('/')}
                  className="px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-2xl transition-all"
