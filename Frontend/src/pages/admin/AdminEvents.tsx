              ...
              <td className="px-6 py-4">
                {event.creatorDetails ? (
                  <div className="flex flex-col gap-0.5">
                    <span className="font-medium text-slate-200 text-sm whitespace-nowrap">
                      {event.creatorDetails.name || 'Unknown User'}
                    </span>
                    <span
                      className="text-slate-500 text-xs truncate max-w-[150px]"
                      title={event.creatorDetails.email}
                    >
                      {event.creatorDetails.email || 'No email'}
                    </span>
                  </div>
                ) : (
