        ...
        <div className="p-8 w-full min-h-screen bg-[#070b14]">
            ...
            <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <div className="flex gap-3">
                    ...
                    <button className="px-5 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-semibold rounded-xl shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_25px_rgba(16,185,129,0.4)] transition-all flex items-center gap-2 cursor-not-allowed opacity-50">
            ...
            <div className="bg-[#0a0f16]/80 backdrop-blur-xl border border-slate-800/60 rounded-2xl p-4 mb-6 flex flex-col md:flex-row gap-4 justify-between items-center shadow-lg">
                <div className="relative w-full md:w-96">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 bg-slate-900/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-hidden focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all text-sm"
                        value={searchTerm}
