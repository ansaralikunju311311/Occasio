        ...
        <div className="print-card bg-slate-900/40 backdrop-blur-xl border border-slate-800/80 rounded-[2rem] overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.7)] flex flex-col">
          ...
          <div className="p-8 border-b border-dashed border-slate-800/80 flex flex-col md:flex-row gap-6 items-start justify-between">
            ...
            <div className="text-right flex flex-col items-end gap-1.5 self-stretch md:self-auto justify-between md:justify-start">
              <span
                className={`px-3.5 py-1 rounded-full text-xs font-black uppercase border tracking-widest ${
          ...
          <div className="p-8 grid md:grid-cols-3 gap-8 items-center border-b border-dashed border-slate-800/80">
            ...
            <div className="md:col-span-2 space-y-6">
              <div>
                <h4 className="print-text-muted text-xs font-bold text-slate-500 uppercase tracking-widest mb-1.5">
                  Attendee Name
                </h4>
                <p className="print-text-dark text-base font-semibold text-white">
              ...
              <div>
                ...
                <p className="print-text-dark text-sm font-semibold text-slate-200">
                  {formatDate(booking.eventId.startTime)}
                </p>
                <p className="print-text-muted text-xs text-indigo-400 font-medium mt-1">
              ...
              {booking.eventId.location?.address && (
                <div>
                  ...
                  <p className="print-text-dark text-sm text-slate-300 leading-relaxed font-light">
                    {booking.eventId.location.address}
                  </p>
                </div>
              )}
            ...
            <div className="flex flex-col items-center justify-center p-4 bg-white/5 rounded-3xl border border-slate-800/60 max-w-[220px] mx-auto w-full">
              ...
              <span className="print-text-muted text-[9px] text-slate-500 uppercase font-black tracking-widest mt-3">
                Scan to Validate
              </span>
            </div>
          </div>
          ...
          <div className="p-8 bg-slate-900/20 grid grid-cols-2 md:grid-cols-4 gap-6 items-center">
            <div>
              ...
              <p className="print-text-dark text-sm font-bold text-slate-200 capitalize">
                {booking.bookingType}
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="print-text-dark text-sm font-bold text-slate-200">
            ...
            <div className="text-right md:text-left">
              ...
              <p className="print-text-dark text-lg font-black text-teal-400">
                ₹{booking.totalAmount}
              </p>
            </div>
          </div>
