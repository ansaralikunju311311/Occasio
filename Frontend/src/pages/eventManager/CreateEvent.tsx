    ...
    <div className="animate-fade-in-up pb-12">
      <div className="mb-8">
        ...
        <p className="text-slate-400 mt-2">
          Set up a new event for your audience with all the details.
        </p>
        <div className="mt-4">
          <HomeButton />
        </div>
              ...
              <input
                {...register('startTime', {
                  ...
                  validate: (value) => {
                    ...
                    return (
                      start.getTime() >= now.getTime() - 60000 || 'Start time cannot be in the past'
                    );
                  },
          ...
          <div className="bg-slate-900/40 backdrop-blur-xl border border-slate-800/60 rounded-2xl p-8 shadow-xl group hover:border-teal-500/30 transition-all duration-300 animate-in fade-in slide-in-from-top-4 delay-75">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">
                    Specify precisely the seating layout for your offline audience. This data is
                    required to publish this event type.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6 animate-in fade-in zoom-in-95 duration-300">
              {layoutBlocks.map((block, blockIndex) => (
                <div
                  key={blockIndex}
                  className="bg-slate-800/40 border border-slate-700 rounded-xl p-5 relative overflow-hidden group/block"
                >
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <h4 className="text-slate-200 font-semibold flex items-center">
                      <span className="bg-slate-700 text-teal-400 text-xs px-2 py-1 rounded mr-2 font-mono">
                        Block {blockIndex + 1}
                      </span>
                    </h4>
                      ...
                      {block.rows.map((row: any, rowIndex: number) => (
                        ...
                        >
                          ...
                          <div className="flex-1 flex items-center bg-slate-900/80 rounded-md border border-slate-700 overflow-hidden focus-within:border-teal-500">
                            <span className="text-[10px] text-slate-500 px-2 bg-slate-800/50 uppercase tracking-wider border-r border-slate-700 h-full flex items-center">
                              Seats
                            </span>
                            <input
                              type="number"
            ...
            {imagePreview ? (
              ...
              <label className="border-2 border-dashed border-slate-700 rounded-xl p-8 text-center bg-slate-800/20 hover:bg-slate-800/50 hover:border-teal-500/50 transition-all cursor-pointer group/upload block">
                ...
                <div className="flex flex-col items-center justify-center">
                  <svg
                    className="w-10 h-10 text-slate-500 mb-3 group-hover/upload:text-teal-400 transition-colors"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                  ...
                  <p className="text-sm text-slate-400 group-hover/upload:text-teal-300">
