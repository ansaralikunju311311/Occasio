        ...
        <div className="min-h-screen flex items-center justify-center bg-[#070b14] relative overflow-hidden font-sans">
            ...
            <div className="w-full max-w-md p-6 relative z-10">
                ...
                <div className="text-center mb-10">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 mb-6 shadow-[0_0_30px_rgb(16,185,129,0.15)]">
                ...
                {/* Login Card */}
                <div className="bg-slate-900/40 backdrop-blur-2xl rounded-4xl p-8 md:p-10 shadow-2xl shadow-black/50 border border-slate-800/60 relative overflow-hidden group">
