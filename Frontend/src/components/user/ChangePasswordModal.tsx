        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden animate-fade-in-up">
                <div className="p-6 border-b border-slate-800 flex justify-between items-center bg-slate-900/50">
                    <h2 className="text-xl font-bold text-white">Change <span className="text-indigo-400">Password</span></h2>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
                    <div>
                        <label className="block text-sm font-semibold text-slate-400 mb-1 uppercase tracking-wider">Current Password</label>
                        <PasswordInput
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-slate-400 mb-1 uppercase tracking-wider">New Password</label>
                        <PasswordInput
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-slate-400 mb-1 uppercase tracking-wider">Confirm New Password</label>
                        <PasswordInput
