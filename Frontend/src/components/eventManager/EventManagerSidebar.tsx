        ...
        <aside className="fixed top-0 left-0 h-screen w-64 bg-[#070b14] border-r border-slate-800/60 flex flex-col z-50">
            ...
            <nav className="flex-1 overflow-y-auto py-6 px-4 space-y-8 custom-scrollbar">
                ...
                <div className="space-y-2">
                    <h3 className="px-4 text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-4">Personal</h3>
                    {personalLinks.map((link) => {
                        ...
                        return (
                            <Link
                                key={link.name}
                                to={link.path}
                                className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-200 group relative ${isActive
                            ...
                            >
                                ...
                                <div className={`${isActive ? "text-indigo-400" : "text-slate-500 group-hover:text-indigo-400 transition-colors"}`}>
                                    {link.icon}
                                </div>
                                {link.name}
                            </Link>
                ...
                {/* Management Section */}
                <div className="space-y-2">
                    <h3 className="px-4 text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-4">Event Management</h3>
            ...
            {showLogoutModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-[#0a0f16] border border-slate-800 rounded-2xl shadow-2xl p-6 w-full max-w-sm animate-fade-in-up">
                        ...
                        <p className="text-slate-400 text-sm mb-6">Are you sure you want to exit the manager dashboard?</p>
